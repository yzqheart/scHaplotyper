...
`perl $Bin/draw_pairwise_crossovers_for_curation.yellow.blue.pl $crossover_file $hiddenseq_file $crossover_file.filter.cluster  $Aneuploidy_chrs_file $draw_pos`;
